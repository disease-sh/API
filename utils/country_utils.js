...
const getCountryData = (countryNameParam) => {
	...
	const nullReturn = { _id: null, country: null, iso2: null, iso3: null, lat: 0, long: 0, flag: `${getConfig().flagsBase}unknown.png` };
	...
	return countryFound ? {
		...
		flag: `${getConfig().flagsBase}${countryFound.iso2.toLowerCase()}.png`
	} : nullReturn;
};
