(window["webpackJsonp"] = window["webpackJsonp"] || []).push([[38], {
  ...
  function node_modulesIonicCoreDistEsmIonModalIosEntryJs(module, __webpack_exports__, __webpack_require__) {
    ...
    const iosEnterAnimation = (baseEl, presentingEl) => {
      ...
      const backdropAnimation = Object(_animation_56279521_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
        'pointer-events': 'none'
