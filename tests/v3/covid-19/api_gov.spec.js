	...
	it('/v3/gov/Israel correct fields set', (done) => {
		chai.request(app)
			...
			.end((err, res) => {
				...
				res.body.data.threeStagePlan.should.have.property('cityData');
				const threeStagePlanFirstCity = res.body.data.threeStagePlan.cityData[0];
				threeStagePlanFirstCity.should.have.property('name');
				threeStagePlanFirstCity.should.have.property('score');
				threeStagePlanFirstCity.should.have.property('color');
				threeStagePlanFirstCity.should.have.property('newCasesPer10kLastWeek');
				threeStagePlanFirstCity.should.have.property('pctPositiveTestsLastWeek');
				threeStagePlanFirstCity.should.have.property('activeCases');
				res.body.data.threeStagePlan.should.have.property('lastUpdate');
