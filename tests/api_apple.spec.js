                ...
                res.body.map((countryName) => {
                    chai.request(app)
					    ...
					    .end((err2, res2) => {
                            ...
                            res2.body[0].should.have.property('subregion').eql('all');
                            res2.body[0].should.have.property('data');
                            res2.body[0].data.length.should.be.at.least(1);
                            res2.body[0].data[0].should.have.property('subregion_and_city');
                            res2.body[0].data[0].should.have.property('geo_type');
                            res2.body[0].data[0].should.have.property('date');
                            res2.body[0].data[0].should.have.property('driving');
                            res2.body[0].data[0].should.have.property('transit');
                            res2.body[0].data[0].should.have.property('walking');
                        });
                });
                done();
            });
    ...
    it('/v2/apple/countries/country/all correct for invalid single sugbregion', (done) => {
        chai.request(app)
            ...
            .end((err, res) => {
                ...
                res.body[0].should.have.property('data');
                res.body[0].data.should.have.property('message');
                done();
            });
    });
    ...
    it('/v2/apple/countries/country/all correct for invalid subregion list', (done) => {
        chai.request(app)
            ...
            .end((err, res) => {
                ...
                res.body[1].should.have.property('data');
                res.body[1].data.should.have.property('message');
                done();
            });
    });
})